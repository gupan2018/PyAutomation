...
class YUNLU(unittest.TestCase):
    def test_login(self):
        ...
        try:
            sleep(3)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品详情\main.png")
            #点击云视产品入口
            createContactButton = driver.find_element_by_id("com.yunlu6.stone:id/cloundview_rl_bottom_product")
            createContactButton.click()
            sleep(2)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品详情\product.png")
            driver.swipe(530,1580,530,463)#滑动屏幕从A点到B点
            sleep(2)#等待两秒后保存A-B的截图
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品详情\上下滑动浏览产品截图.png")
            ...
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品详情\第一个标签.png")
            sleep(1)
            createContactButton2.click()
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品详情\第二个标签.png")
            sleep(1)
            ...
            #     createContactButton.click()
            #     sleep(1)
            #     driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品详情\各个标签的截图%d.png"%(i+1))
            #     sleep(1)
            ...
            createContactButton.click()
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品详情\第一个标签下的第一个产品图片.png")
            sleep(1)
            ...
            sleep(2)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品详情\产品详情页.png")
            sleep(2)

            createContactButton = driver.find_element_by_id("com.yunlu6.stone:id/tv_middle")
            createContactButton.click()
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品详情\产品参数.png")
            sleep(1)

            createContactButton = driver.find_element_by_id("com.yunlu6.stone:id/tv_right")
            createContactButton.click()
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品详情\关联信息.png")
            sleep(1)

        except Exception as e:
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品详情\exception.png")
            log_file='C:\\Users\\xiaoj\Desktop\exceptionLog\log-002.txt'
