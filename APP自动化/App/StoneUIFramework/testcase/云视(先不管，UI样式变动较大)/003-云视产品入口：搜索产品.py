...
class YUNLU(unittest.TestCase):
    def test_login(self):
        ...
        try:
            sleep(2)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品搜索\main.png")
            #点击云视产品入口
            createContactButton = driver.find_element_by_id("com.yunlu6.stone:id/cloundview_rl_bottom_product")
            createContactButton.click()
            sleep(2)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品搜索\product.png")
            sleep(1)
            ...
            sleep(2)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品搜索\搜索西班牙米黄.png")
            sleep(2)
            search_button = driver.find_element_by_id("com.yunlu6.stone:id/iv_search")
            search_button.click()
            sleep(2)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品搜索\搜索结果.png")
            sleep(1)
            ...
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品搜索\第一个西班牙米黄.png")
            sleep(1)
            ...
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品搜索\产品详情信息.png")
            sleep(1)
            ...
            createContactButton.click()
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品搜索\关联信息.png")
            sleep(1)

        except Exception as e:
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视产品搜索\exception.png")
            log_file='C:\\Users\\xiaoj\Desktop\exceptionLog\log003.txt'
