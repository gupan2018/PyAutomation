...
class YUNLU(unittest.TestCase):
    def test_login(self):
        ...
        try:
            sleep(2)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视搜索企业\main.png")

            #点击云视企业入口
            createContactButton = driver.find_element_by_id("com.yunlu6.stone:id/cloundview_rl_bottom_company")
            createContactButton.click()
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视搜索企业\企业列表.png")
            sleep(1)
            ...
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视搜索企业\环球万国.png")

            #点击搜索出来的企业
            driver.find_elements_by_id("com.yunlu6.stone:id/iv_logo")[0].click()
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视搜索企业\环球万国名片页.png")
            driver.quit()

        except Exception as e:
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视搜索企业\exception.png")
            log_file='C:\\Users\\xiaoj\Desktop\exceptionLog\log005.txt'
