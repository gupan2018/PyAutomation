...
class YUNLU(unittest.TestCase):
    def test_login(self):
        ...
        try:
            sleep(2)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视浏览企业\main.png")

            #点击云视企业入口
            createContactButton = driver.find_element_by_id("com.yunlu6.stone:id/cloundview_rl_bottom_company")
            createContactButton.click()
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视浏览企业\企业列表.png")
            sleep(1)

            #浏览企业列表
            driver.swipe(500,1764,500,331)#滑动屏幕从A点到B点
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视浏览企业\AToB.png")

            driver.swipe(447,1806,447,1083)#刷新
            sleep(1)
            driver.swipe(447,1806,447,1083)#上滑浏览
            sleep(1)
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视浏览企业\下拉刷新企业列表.png")
            sleep(1)
            driver.quit()

        except Exception as e:
            driver.save_screenshot("C:\\Users\\xiaoj\Desktop\screenshot\云视浏览企业\exception.png")
            log_file='C:\\Users\\xiaoj\Desktop\exceptionLog\log004.txt'
