...
#*********************************【PAGE6】人脉首页-搜索-标签列表-点击进入群聊-主菜单-设置-群头像-头像：RMSY_search_label_groupchat_menu_setting_grouphead_head*********************************
    ...
    def RMSY_search_label_groupchat_menu_setting_grouphead_head_takephoto(self):
        self.RMSY_search_label_groupchat_menu_setting_grouphead_head_takephoto = self.p.get_element("id->com.yunlu6.stone:id/tv_cloundlibrary_camera", "人脉首页-搜索-标签列表-点击进入群聊-主菜单-设置-群头像-头像-拍照")
