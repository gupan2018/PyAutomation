...
class _AscSpaceTeamPage(_AscSpaceMenuPage):
    #--------------------------------------团队-------------------------------------
    # 空间列表-浏览协会空间-菜单栏-团队
    ...
    def Kjlb_browseascspace_menu_team_menu_assignjob_contact(self):
        self.Kjlb_browseascspace_menu_team_menu_assignjob_contact = self.p.get_elements("id->com.yunlu6.stone:id/removaljobs_name","空间列表-浏览协会空间-菜单栏-团队-菜单栏-人事任免-联系人列表")
    ...
    def Kjlb_browseascspace_menu_team_menu_assignjob_contact_department(self):
        self.Kjlb_browseascspace_menu_team_menu_assignjob_contact_department = self.p.get_elements("id->com.yunlu6.stone:id/setjobs_unassi_jobname","空间列表-浏览协会空间-菜单栏-团队-菜单栏-人事任免-联系人列表-部门名称")
    ...
    def Kjlb_browseascspace_menu_team_menu_assignjob_contact_jobname(self):
        self.Kjlb_browseascspace_menu_team_menu_assignjob_contact_jobname = self.p.get_elements("id->com.yunlu6.stone:id/tag_id","空间列表-浏览协会空间-菜单栏-团队-菜单栏-人事任免-联系人列表-职位名称")
    ...
    def Kjlb_browseascspace_menu_team_menu_assignjob_addperson_choose(self):
        self.Kjlb_browseascspace_menu_team_menu_assignjob_addperson_all = self.p.get_elements("id->com.yunlu6.stone:id/item_client_tv_checked","空间列表-浏览协会空间-菜单栏-团队-菜单栏-人事任免-新增-圆圈勾选")
        return self.Kjlb_browseascspace_menu_team_menu_assignjob_addperson_all

    # 空间列表-浏览协会空间-菜单栏-团队-菜单栏-人事任免-新增-联系人列表
    def Kjlb_browseascspace_menu_team_menu_assignjob_addperson_contact(self):
        self.Kjlb_browseascspace_menu_team_menu_assignjob_addperson_contact = self.p.get_elements("id->com.yunlu6.stone:id/item_client_username_tv","空间列表-浏览协会空间-菜单栏-团队-菜单栏-人事任免-新增-圆圈勾选")
