...
#***************************************【PAGE3】已发布产品列表Kjlb_browseorgspace_menu_product_lock_list***************************************
   #  空间列表-浏览企业空间-菜单栏-产品-已发布-产品列表-商品名:点击
    ...
    def Kjlb_browseorgspace_menu_product_lock_list_moreprice_list_click(self,n):
        return self.p.click(self.Kjlb_browseorgspace_menu_product_lock_list_moreprice_list()[n])
...
#***************************************【PAGE3】未发布产品列表Kjlb_browseorgspace_menu_product_unlock_list***************************************
    ...
    def Kjlb_browseorgspace_menu_product_unlock_list_moreprice_list_click(self,n):
        return self.p.click(self.Kjlb_browseorgspace_menu_product_unlock_list_moreprice_list()[n])
...
# ***************************************【PAGE3】【PAGE3】人事任免Kjlb_browseorgspace_menu_team_menu_assignjob***************************************
    ...
    def Kjlb_browseorgspace_menu_team_menu_assignjob_contact_click(self,n):
        return self.p.click(self.Kjlb_browseorgspace_menu_team_menu_assignjob_contact()[n])
...
# ***************************************【PAGE3】右上角新增按钮Kjlb_browseorgspace_menu_archivies_new***************************************
    ...
    def Kjlb_browseorgspace_menu_archivies_new_type_typelist_click(self,n):
        return self.p.click(self.Kjlb_browseorgspace_menu_archivies_new_type_typelist()[n])

    # 空间列表-浏览企业空间-菜单栏-资讯-新增按钮-类型-类型列表-企业身份列表:点击
    def Kjlb_browseorgspace_menu_archivies_new_type_typelist_orglist_click(self,n):
        return self.p.click(self.Kjlb_browseorgspace_menu_archivies_new_type_typelist_orglist()[n])
    ...
    def Kjlb_browseorgspace_menu_archivies_new_confirm_late_click(self):
        return self.p.click(self.Kjlb_browseorgspace_menu_archivies_new_confirm_late())

    # 空间列表-浏览企业空间-菜单栏-资讯-新增按钮-勾选按钮-保存并发布:点击
    def Kjlb_browseorgspace_menu_archivies_new_confirm_now_click(self):
        return self.p.click(self.Kjlb_browseorgspace_menu_archivies_new_confirm_now())
...
# ***************************************【PAGE3】资讯图片列表Kjlb_browseorgspace_menu_archivies_pic***************************************
    ...
    def Kjlb_browseorgspace_menu_archivies_pic_menu_edit_click(self,n):
        return self.p.click(self.Kjlb_browseorgspace_menu_archivies_pic_menu_edit())

    # 空间列表-浏览企业空间-菜单栏-资讯-图片列表-图片-菜单栏-删除:点击
    def Kjlb_browseorgspace_menu_archivies_pic_menu_delete_click(self,n):
...
# ***************************************【PAGE3】菜单栏-编辑Kjlb_browseorgspace_menu_bcard_menu_edit***************************************
    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-返回:点击
    def Kjlb_browseorgspace_menu_bcard_menu_edit_back_click(self):
        return self.p.click(self.Kjlb_browseorgspace_menu_bcard_menu_edit_back())

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-Logo:发送文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_logo_sendkeys(self,text):
        return self.p.send_keys(self.Kjlb_browseorgspace_menu_bcard_menu_edit_logo(),text)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-Logo-相册:点击
    def Kjlb_browseorgspace_menu_bcard_menu_edit_logo_album_click(self):
        return self.p.click(self.Kjlb_browseorgspace_menu_bcard_menu_edit_logo_album())

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-Logo-拍照:点击
    def Kjlb_browseorgspace_menu_bcard_menu_edit_logo_takepic_click(self):
        return self.p.click(self.Kjlb_browseorgspace_menu_bcard_menu_edit_logo_takepic())

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-Logo-取消:点击
    def Kjlb_browseorgspace_menu_bcard_menu_edit_logo_cancel_click(self):
        return self.p.click(self.Kjlb_browseorgspace_menu_bcard_menu_edit_logo_cancel())

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-企业全称:发送文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_fullname_sendkeys(self,text):
        return self.p.send_keys(self.Kjlb_browseorgspace_menu_bcard_menu_edit_fullname(),text)

     # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-企业简称:发送文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_simplename_sendkeys(self,text):
        return self.p.send_keys(self.Kjlb_browseorgspace_menu_bcard_menu_edit_simplename(),text)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-所在地区:点击
    def Kjlb_browseorgspace_menu_bcard_menu_edit_address_click(self):
        return self.p.click(self.Kjlb_browseorgspace_menu_bcard_menu_edit_address())
    ...
    def Kjlb_browseorgspace_menu_bcard_menu_edit_detailaddress_sendkeys(self,text):
        return self.p.send_keys(self.Kjlb_browseorgspace_menu_bcard_menu_edit_detailaddress(),text)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-联系人:发送文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_contact_sendkeys(self,text):
        return self.p.send_keys(self.Kjlb_browseorgspace_menu_bcard_menu_edit_contact(),text)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-手机号:发送文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_phone_sendkeys(self,text):
        return self.p.send_keys(self.Kjlb_browseorgspace_menu_bcard_menu_edit_phone(),text)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-座机号:发送文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_landline_sendkeys(self,text):
        return self.p.send_keys(self.Kjlb_browseorgspace_menu_bcard_menu_edit_landline(),text)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-邮箱:发送文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_email_sendkeys(self,text):
        return self.p.send_keys(self.Kjlb_browseorgspace_menu_bcard_menu_edit_email(),text)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-QQ:发送文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_QQ_sendkeys(self,text):
        return self.p.send_keys(self.Kjlb_browseorgspace_menu_bcard_menu_edit_QQ(),text)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-网站:发送文本
    def Kjlb_browseorgspace_menu_bcard_menu_edit_website_sendkeys(self,text):
        return self.p.send_keys(self.Kjlb_browseorgspace_menu_bcard_menu_edit_website(),text)

    # 空间列表-浏览企业空间-菜单栏-企业名片-菜单栏-编辑-勾选:点击
    def Kjlb_browseorgspace_menu_bcard_menu_edit_confirm_click(self):
        return self.p.click(self.Kjlb_browseorgspace_menu_bcard_menu_edit_confirm())
...
# ***************************************【PAGE3】菜单栏-分类到Kjlb_browseperspace_piclist_classify***************************************
    ...
    def Kjlb_browseperspace_piclist_classify_spaceById_click(self):
        return self.p.click(self.Kjlb_browseperspace_piclist_classify_spaceById())
    ...
    def Kjlb_browseperspace_piclist_classify_back_click(self):
        return self.p.click(self.Kjlb_browseperspace_piclist_classify_back())

    # 空间列表-浏览私人空间-照片列表-分类到-勾选
    def Kjlb_browseperspace_piclist_classify_confirm_click(self):
        return self.p.click(self.Kjlb_browseperspace_piclist_classify_confirm())

    # 空间列表-浏览私人空间-照片列表-分类到-文件夹ById
    def Kjlb_browseperspace_piclist_classify_folderByID_click(self):
        return self.p.click(self.Kjlb_browseperspace_piclist_classify_folderByID())
...
# ***************************************【PAGE3】加数据-相册Kjlb_browseperspace_addData_ByAlbum***************************************
    ...
    def Kjlb_browseperspace_addData_ByAlbum_back_click(self):
        return self.p.click(self.Kjlb_browseperspace_addData_ByAlbum_back())
...
# ***************************************【PAGE3】菜单栏-编辑Kjlb_browseperspace_more_menu_edit***************************************
    ...
    def Kjlb_browseperspace_more_menu_edit_deletefolder_click(self,n):
        return self.p.click(self.Kjlb_browseperspace_more_menu_edit_deletefolder()[n])
    ...
    def Kjlb_browseperspace_more_menu_edit_spacetype_click(self):
        return self.p.click(self.Kjlb_browseperspace_more_menu_edit_spacetype())

     # 空间列表-浏览私人空间-更多-菜单栏-编辑-空间类型-选择空间类型
    def Kjlb_browseperspace_more_menu_edit_spacetype_choosetype_click(self):
        return self.p.click(self.Kjlb_browseperspace_more_menu_edit_spacetype_choosetype())

    # 空间列表-浏览私人空间-更多-菜单栏-编辑-修改空间名按钮
    def Kjlb_browseperspace_more_menu_edit_editsbtn_click(self):
        return self.p.click(self.Kjlb_browseperspace_more_menu_edit_editsbtn())

    # 空间列表-浏览私人空间-更多-菜单栏-编辑-修改空间名按钮-空间名称
    def Kjlb_browseperspace_more_menu_edit_editsbtn_sname_click(self):
        return self.p.click(self.Kjlb_browseperspace_more_menu_edit_editsbtn_sname())
...
# ***************************************【PAGE3】菜单栏-排序Kjlb_browseperspace_more_menu_sort***************************************
    ...
    def Kjlb_browseperspace_more_menu_sort_piclist_click(self,n):
        return self.p.click(self.Kjlb_browseperspace_more_menu_sort_piclist()[n])